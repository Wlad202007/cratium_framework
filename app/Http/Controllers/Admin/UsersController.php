...
class UsersController extends Controller
{
    ...
    public function show(User $user)
    {
        ...
        $user->load('roles', 'team', 'headUnits', 'headGroups', 'moderatorActivities', 'userAnswers', 'adminFolders', 'authorDocuments', 'authorReviews', 'userSignatures', 'authorScores', 'userScores', 'authorPublications', 'authorActivities', 'managersUnits', 'membersGroups', 'authorsCourses', 'checkinActivities', 'usersFolders', 'sharesDocuments');
