...
class SkillsController extends Controller
{
    public function index()
    {
        ...
        return view('admin.skills.index', compact('skills', 'courses'));
    }
    ...
    public function create()
    {
        ...
        $cources = Course::all()->pluck('name', 'id');

        return view('admin.skills.create', compact('cources'));
    }

    public function store(StoreSkillRequest $request)
    {
        $skill = Skill::create($request->all());
        $skill->cources()->sync($request->input('cources', []));
    ...
    public function edit(Skill $skill)
    {
        ...
        return view('admin.skills.edit', compact('cources', 'skill'));
    }
    ...
    public function show(Skill $skill)
    {
        ...
        $skill->load('cources', 'skillsUsers');
