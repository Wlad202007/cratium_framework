        ...
        <div class="form-group">
            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.unit.fields.financial_details') }}
                        </th>
                        <td>
                            {!! $unit->financial_details !!}
                        </td>
                    </tr>
                </tbody>
            </table>
...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#unit_bills" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" role="tabpanel" id="unit_bills">
            @includeIf('admin.units.relationships.unitBills', ['bills' => $unit->unitBills])
        </div>
