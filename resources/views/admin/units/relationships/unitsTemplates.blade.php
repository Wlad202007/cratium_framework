...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-unitsTemplates">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($templates as $key => $template)
                        <tr data-entry-id="{{ $template->id }}">
                            ...
                            <td>
                                @foreach($template->units as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-unitsTemplates:not(.ajaxTable)').DataTable({ buttons: dtButtons })
