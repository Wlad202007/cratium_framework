    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.units.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('financial_details') ? 'is-invalid' : '' }}" name="financial_details" id="financial_details">{!! old('financial_details') !!}</textarea>
