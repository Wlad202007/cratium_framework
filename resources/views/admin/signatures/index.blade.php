...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Signature">
            <thead>
                <tr>
                    <th width="10">
                    ...
                    <td>
                        <select class="search">
                            ...
                            @foreach($documents as $key => $item)
                                <option value="{{ $item->int_number }}">{{ $item->int_number }}</option>
                            @endforeach
                        </select>
                    </td>
                    <td>
                        <select class="search" strict="true">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach(App\Models\Signature::STATUS_SELECT as $key => $item)
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.signatures.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'user_name', name: 'user.name' },
{ data: 'document_int_number', name: 'document.int_number' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Signature').DataTable(dtOverrideGlobals);
