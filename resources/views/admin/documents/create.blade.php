    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.documents.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('int_number') ? 'is-invalid' : '' }}" type="text" name="int_number" id="int_number" value="{{ old('int_number', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ext_number') ? 'is-invalid' : '' }}" type="text" name="ext_number" id="ext_number" value="{{ old('ext_number', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('shares') ? 'is-invalid' : '' }}" name="shares[]" id="shares" multiple>
                    @foreach($shares as $id => $shares)
                        <option value="{{ $id }}" {{ in_array($id, old('shares', [])) ? 'selected' : '' }}>{{ $shares }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('folders') ? 'is-invalid' : '' }}" name="folders[]" id="folders" multiple>
                    @foreach($folders as $id => $folders)
                        <option value="{{ $id }}" {{ in_array($id, old('folders', [])) ? 'selected' : '' }}>{{ $folders }}</option>
                    @endforeach
                </select>
