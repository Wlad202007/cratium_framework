    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.publications.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('edition') ? 'is-invalid' : '' }}" name="edition" id="edition" required>
                    ...
                    @foreach(App\Models\Publication::EDITION_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('edition', 'scopus') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('database') ? 'is-invalid' : '' }}" name="database" id="database">
                    ...
                    @foreach(App\Models\Publication::DATABASE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('database', 'other') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('edition_number') ? 'is-invalid' : '' }}" type="text" name="edition_number" id="edition_number" value="{{ old('edition_number', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pages_count') ? 'is-invalid' : '' }}" type="number" name="pages_count" id="pages_count" value="{{ old('pages_count', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" name="type" id="type" required>
                    ...
                    @foreach(App\Models\Publication::TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('type', 'other') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('type'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('coauthors') ? 'is-invalid' : '' }}" name="coauthors" id="coauthors">{{ old('coauthors') }}</textarea>
