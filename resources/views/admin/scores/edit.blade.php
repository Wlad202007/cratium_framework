    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.scores.update", [$score->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('model') ? 'is-invalid' : '' }}" type="number" name="model" id="model" value="{{ old('model', $score->model) }}" step="1">
                @if($errors->has('model'))
                    <div class="invalid-feedback">
                        {{ $errors->first('model') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('model_type') ? 'is-invalid' : '' }}" type="text" name="model_type" id="model_type" value="{{ old('model_type', $score->model_type) }}">
