...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#user_bills" role="tab" data-toggle="tab">
                {{ trans('cruds.bill.title') }}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#author_bills" role="tab" data-toggle="tab">
                {{ trans('cruds.bill.title') }}
            </a>
        </li>
        <li class="nav-item">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" role="tabpanel" id="user_bills">
            @includeIf('admin.users.relationships.userBills', ['bills' => $user->userBills])
        </div>
